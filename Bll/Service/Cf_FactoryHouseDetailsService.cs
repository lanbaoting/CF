...
{
    public class Cf_FactoryHouseDetailsService : BaseService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Cf_FactoryHouseDetials GetFactoryHouseDetials(int factoryHouseId)
        {
            try
            {
                var factoryHouse = Context.Cf_FactoryHouseDetials.FirstOrDefault(w => w.FactoryHouseId == factoryHouseId);
                return factoryHouse;
            }
            catch (Exception e)
            {
