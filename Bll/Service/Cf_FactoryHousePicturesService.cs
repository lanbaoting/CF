...
{
    public class Cf_FactoryHousePicturesService : BaseService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Cf_FactoryHousePictures> GetFactoryHousePicturesList(int factoryHouseId)
        {
            try
            {
                var list = Context.Cf_FactoryHousePictures.Where(w => w.FactoryHouseId == factoryHouseId).ToList();
                return list;
            }
            catch (Exception e)
            {
